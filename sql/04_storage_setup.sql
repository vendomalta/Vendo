    ...
    -- Restricted Public Read Access to specific buckets
    DROP POLICY IF EXISTS "Public read" ON storage.objects;
    CREATE POLICY "Public read" ON storage.objects FOR SELECT 
    USING (bucket_id IN ('listing-photos', 'profile-photos', 'banners', 'site-assets'));
    ...
    -- Owner Resource Management (Strict Folder Mapping)
    ...
    -- Specific Delete Policy for Owners
